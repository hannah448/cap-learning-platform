...
(function () {
    ...
    const CATALOG = [
        { id: '1',  name: 'Marketing Digital Complet pour Entrepreneurs',  price: 25000, category: 'marketing',     page: 'formation-marketing-digital',    duration: 57, modules: 16 },
        { id: '2',  name: 'E-commerce & Paiements Digitaux',               price: 30000, category: 'ecommerce',     page: 'formation-ecommerce',            duration: 79, modules: 47 },
        { id: '3',  name: 'IA & Business : Automatisation & Productivité', price: 30000, category: 'ia',            page: 'formation-ia-business',          duration: 48, modules: 26 },
        { id: '5',  name: 'Réseaux Sociaux & Community Management',        price: 18000, category: 'marketing',     page: 'formation-reseaux-sociaux',      duration: 41, modules: 25 }
    ];
    ...
    const AdminData = {
        ...
        requireAdmin(redirect) {
            ...
            if (!s || s.role !== 'admin') {
                if (redirect !== false) location.href = 'connexion';
                return false;
            }
            return s;
        },
